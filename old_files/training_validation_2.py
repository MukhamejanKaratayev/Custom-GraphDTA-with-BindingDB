...
datasets = [['davis','kiba','Ki','Kd','IC50'][int(sys.argv[1])]] 
...
for dataset in datasets:
    ...
    if ((not os.path.isfile(processed_data_file_train)) or (not os.path.isfile(processed_data_file_test))):
        ...
        best_epoch = -1
        if dataset == 'Ki' or dataset == 'Kd' or dataset == 'IC50':
            model_file_name = 'model_' + model_st + '_bindingdb_' + dataset +  '.model'
            result_file_name = 'result_' + model_st + '_bindingdb_' + dataset +  '.csv'
        else:
